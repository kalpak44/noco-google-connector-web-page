<!-- Managed by homelab-infra — terraform/github/noco-google-connector-web-page/agent-prompts/ai-maintenance-agent.md -->
<!-- Edits made here in the target repo are overwritten by `just deploy github noco-google-connector-web-page`. -->
